 ...
 * @create 2018/9/28
 */
public class BlockingQueue2Demo {

	private static Logger log = Logger.getLogger("logWarn");
	
	static class TakeThread extends Thread{
		int id;
		BlockingQueue2 blockQueue;
		
		public TakeThread(int id, BlockingQueue2 blockQueue) {
			super();
			this.id = id;
	...
	static class PutThread extends Thread{
		...
		public PutThread(int id, BlockingQueue2 blockQueue) {
			super();
			this.id = id;
			this.blockQueue = blockQueue;
		}
	...
	public static void main(String[] args) {
		final BlockingQueue2 blockQueue = new BlockingQueue2();
